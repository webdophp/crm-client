        ...
        <v-dialog v-model="dialogImage" fullscreen hide-overlay transition="dialog-bottom-transition">
            <v-card>
                <v-toolbar dark color="primary">
                    ...
                    <v-toolbar-title>{{ $t('add_logo') }}</v-toolbar-title>
                    <v-spacer></v-spacer>
                    <v-toolbar-items>
                ...
                <v-card-text>
                    <v-row v-resize="onResize" align="center" justify="center">
                        <v-col v-if="!edit" cols="12">
                            <v-file-input v-if="!edit" v-model="imageFile" accept=".svg,.png,.jpg,.jpeg"
                                          :show-size="1024" @change="setupCropper" :label="$t('image_file')"
            ...
            <v-row>
                <v-col cols="12" class="pb-0">
                    <v-container class="pa-2">
                        ...
                        <v-img v-if="!imageSrc" :src="defaultLogo" contain></v-img>
                    </v-container>
                </v-col>
            </v-row>
            <v-row v-if="!readonly">
...
export default {
    ...
    mounted() {
        this.imageSrc = this.src ? this.src : null
    },
    methods: {
        onResize() {

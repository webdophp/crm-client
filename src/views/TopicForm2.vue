                ...
                <v-col cols="12" class="">
                    ...
                    >
                        <v-card id="book"
                            ...
                            class="d-flex flex-column fill-height mb-1"
                    ...
                    <v-card flat>
                        ...
                        >
                            ...
                            <template v-slot:append-outer>
                                <v-icon class="pt-2" @click="SentMessage()">mdi-send</v-icon>
                            </template>
                        ...
                        <!--<v-text-field
                                ...
                                @click:append="sheet_paperclip=true"
                                :label="$t('message')"
                                type="text"
                                no-details
                                outlined
                                ...
                                @keyup.enter="SentMessage()"
                                @click:append-outer="SentMessage()"
                                hide-details
                                :disabled="loading"
                                v-if="topic_active"
